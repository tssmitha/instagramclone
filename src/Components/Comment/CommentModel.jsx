      ...
      <ModalContent>
        <ModalBody>
          <div style={{ display: 'flex', height: '75vh', position: 'relative' }}>
            ...
            <div style={{ border: 'solid #e2e8f0', width: '45%', marginLeft: '10px', marginBottom: '10px', display: 'flex', flexDirection: 'column', height: '100%', flexGrow: '1' }}>
              ...
              <div style={{ flex: '1', overflowY: 'auto', margin: '10px' }} className="comment">
                {[1, 1, 1, 1, 1, 1, 1].map(() => <CommentCard key={Math.random()} />)}
              </div>
